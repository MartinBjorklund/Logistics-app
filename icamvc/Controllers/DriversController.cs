...
namespace ICAMVC.Controllers
{
    ...
    public class DriversController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BadgeId,Name")] Driver driver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BadgeId,Name")] Driver driver)
        {
            if (id != driver.Id)
            {
                return NotFound();
